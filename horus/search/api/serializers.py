...
from horus.service.models import Bank, Restraunt, Hotel
from horus.search.documents import BankDocsument, RestrauntDocsument, HotelDocsument
from horus.service.api.serializers import BankSerializer, HotelSerializer, RestrauntSerializer 
...
class SearchSerializerResponse:
    ...
    docs = {
        Bank: BankDocsument,
        Restraunt: RestrauntDocsument,
        Hotel: HotelDocsument
    }
    ...
    def search(cls, request) -> dict:
        ...
        for service, doc in cls.docs.items():
            ...
            s = doc.search().query("multi_match", fields=fields, fuzziness='AUTO', query=q).exclude("match", is_latest=True)
